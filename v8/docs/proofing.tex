...
\author{%
    ...
    \texttt{Draft Findings - 4th December 2025}
}
\date{}
...
The following figures from the benchmark suite support our theoretical analysis:

\begin{figure}[h]
\centering
\fbox{\parbox{0.8\textwidth}{
\centering
\textit{Reference: \texttt{figures\_ieee/fig\_summary\_table.pdf}}\\[1em]
Performance Summary Table showing ZGQ wins on 3/4 metrics
}}
\caption{Summary comparison at 100K scale showing metric-by-metric winners}
\label{fig:summary}
\end{figure}
...
\fbox{\parbox{0.8\textwidth}{
\centering
\textit{Reference: \texttt{figures\_ieee/fig\_recall\_vs\_qps.pdf}}\\[1em]
Recall-QPS Pareto frontier comparison
}}
\caption{Pareto frontier showing ZGQ's superior recall-throughput trade-off}
\label{fig:pareto}
\end{figure}
...
\fbox{\parbox{0.8\textwidth}{
\centering
\textit{Reference: \texttt{figures\_ieee/fig\_latency\_comparison.pdf}}\\[1em]
Query latency distribution comparison
}}
\caption{Latency comparison demonstrating ZGQ's lower query response time}
\label{fig:latency}
\end{figure}
...
\fbox{\parbox{0.8\textwidth}{
\centering
\textit{Reference: \texttt{figures\_ieee/fig\_radar\_chart.pdf}}\\[1em]
Multi-dimensional performance radar chart
}}
\caption{Radar chart showing ZGQ's advantages across multiple dimensions}
\label{fig:radar}
\end{figure}
